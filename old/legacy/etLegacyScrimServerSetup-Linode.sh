...
# GitHub:  https://github.com/csmaxpower/MoesTavern-GameServers/blob/main/server-install/etLegacyServerSetup.sh
...
function includeDependencies() {
    ...
    source "${current_dir}/etLegacyScrimSetupLibrary-Linode.sh"
}
